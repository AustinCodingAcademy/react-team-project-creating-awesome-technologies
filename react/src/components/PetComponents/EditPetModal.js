  ...
  render() {
    return (
      <div>
        ...
        <Modal name="editModal" isOpen={this.state.modal} toggle={this.toggle} className={this.props.title}>
            ...
            <ModalBody>                   
              ...
              <FormGroup check>
                <Label for="altered" check>
                  <Input type="checkbox" id="altered" name="altered"/>      Altered?
                </Label>
              </FormGroup>                        
            </ModalBody>

            <ModalFooter>
              <Button color="info" type="submit" onClick={this.toggle}>Update Pet</Button>{' '}
